...
<!-- BANNER -->
<img src="./screenshots/orchestrai-banner.png" width="100%" alt="OrchestrAI — Autonomous Multi-Agent Intelligence Platform"/>
...
[![Three.js](https://img.shields.io/badge/Three.js_R3F-000000?style=for-the-badge&logo=threedotjs&logoColor=white)](https://threejs.org)
...
```mermaid
flowchart TD
    U([👤 User / Operator]) --> HP[🏠 Homepage\nMission Briefing]
    HP --> MD[📋 Mission Dossier\nClassified Brief]
    HP --> DB[🗺️ Dashboard\nDigital Twin]

    DB --> AN[🤖 Agents Page\nIntelligence Mesh]
    DB --> MS[📁 Missions Page\nOperational Archive]
    MS --> MC[⚙️ Create Mission\nConfiguration Form]
    MC --> OR[⚡ Orchestrate\nCommand Execution]

    OR --> AM{🕸️ Agent Mesh\n5 Autonomous Agents}

    AM --> AA[🔴 Allocation Agent\nCenter-Candidate Mapping]
    AM --> RA[🟡 Risk Agent\nThreat Surface Analysis]
    AM --> OA[🟣 Operations Agent\nLogistics Coordination]
    AM --> CA[🟢 Communication Agent\nEscalation & Signaling]
    AM --> IA[🔵 Intelligence Agent\nDecision Synthesis]

    AA & RA & OA & CA & IA --> DT[🌐 Digital Twin Layer\nLive Operational Mirror]

    DT --> EX[⚙️ Execution Engine\nAutonomous Decisions]
    EX --> AT[📊 Analytics\nIntelligence Archive]

    AT --> ORG[(🧠 Organizational Memory\nFuture Mission Context)]

    style AM fill:#1a0008,stroke:#C4002B,color:#fff
    style DT fill:#0a0a1a,stroke:#BF8C2C,color:#fff
    style EX fill:#0a0008,stroke:#C4002B,color:#fff
    style AT fill:#080810,stroke:#9d4edd,color:#fff
    style ORG fill:#050510,stroke:#9d4edd,color:#fff
```
...
sequenceDiagram
    ...
    participant MC as ⚙️ Mission Config
    participant AM as 🕸️ Agent Mesh
    participant DT as 🌐 Digital Twin
    participant AN as 📊 Analytics

    O->>MC: Define mission parameters
    Note over MC: Operation name · candidate count<br/>centers · region · priority · objectives

    MC->>AM: 🚀 Trigger orchestration
    activate AM

    AM->>AM: 🟡 Risk Agent — threat surface analysis
    AM->>AM: 🔴 Allocation Agent — center-candidate optimization
    AM->>AM: 🟣 Operations Agent — logistics sequencing
    AM->>AM: 🟢 Communication Agent — escalation routing
    AM->>AM: 🔵 Intelligence Agent — decision synthesis

    AM->>DT: Stream operational state updates
    DT-->>O: Live operational picture

    AM->>O: Surfaced recommendations + confidence scores
    O->>AM: Approve / adjust / override

    deactivate AM

    AM->>AN: Write mission intelligence
    AN->>AN: Generate executive summary + projections
    AN-->>O: 📋 Mission Dossier ready
```
...
![](https://img.shields.io/badge/System_Architecture-C4002B?style=flat-square&logoColor=white)
![](https://img.shields.io/badge/AI_Agent_Design-C4002B?style=flat-square&logoColor=white)
![](https://img.shields.io/badge/Product_Strategy-C4002B?style=flat-square&logoColor=white)
...
![](https://img.shields.io/badge/React_/_Three.js-BF8C2C?style=flat-square&logoColor=white)
![](https://img.shields.io/badge/UI/UX_Design-BF8C2C?style=flat-square&logoColor=white)
![](https://img.shields.io/badge/Motion_Design-BF8C2C?style=flat-square&logoColor=white)
...
![](https://img.shields.io/badge/Test_Architecture-9d4edd?style=flat-square&logoColor=white)
![](https://img.shields.io/badge/Quality_Engineering-9d4edd?style=flat-square&logoColor=white)
![](https://img.shields.io/badge/Technical_Docs-9d4edd?style=flat-square&logoColor=white)
...
![](https://img.shields.io/badge/Infrastructure-00B4D8?style=flat-square&logoColor=white)
![](https://img.shields.io/badge/Research-00B4D8?style=flat-square&logoColor=white)
![](https://img.shields.io/badge/Backend_Systems-00B4D8?style=flat-square&logoColor=white)
